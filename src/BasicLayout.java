        ...
        buttn_2.addActionListener( new ActionListener() {
         ...
         if (newState == null) {
            ...
            if (now - lastClick2 < 2000) {
                ...
                switch (inputType) {
                    case "ABC": if(count >= 3) { count = 0; }
                                      break;
                    case "abc": if(count >= 6) { count = 3; }
                                      break;
                    case "123":   if(count >= values2.length) { count = 6; }
                }
            ...
            public void actionPerformed( ActionEvent ev ) { 
                ...
                if (newState == null) {
                    ...
                    switch (inputType) {
                        ...
                        case "abc": if(count >= 6) { count = 3; }
                                          break;
                        case "123":   if(count >= values3.length) { count = 6; }
                    }
            ...
            public void actionPerformed( ActionEvent ev ) {
                ...
                if (newState == null) {
                    ...
                    switch (inputType) {
                        ...
                        case "abc": if(count >= 6) { count = 3; }
                                          break;
                        case "123":   if(count >= values4.length) { count = 6; }
                    }
            ...
            public void actionPerformed( ActionEvent ev ) {
                ...
                if (newState) { 
                    ...
                    if (now - lastClick5 < 2000) {
                        ...
                        case "abc": if(count >= 6) { count = 3; }
                                          break;
                        case "123":   if(count >= values5.length) { count = 6; }
                       }
            ...
            public void actionPerformed( ActionEvent ev ) {
                ...
                if (newState) { 
                    ...
                    if (now - lastClick5 < 2000) {
                        ...
                        case "abc": if(count >= 6) { count = 3; }
                                          break;
                        case "123":   if(count >= values6.length) { count = 6; }
                       }
            ...
            public void actionPerformed( ActionEvent ev ) {
                ...
                if (newState) { 
                    ...
                    if (now - lastClick7 < 2000) {
                        ...
                        switch (inputType) {
                        case "ABC": if(count >= 4) { count = 0; }
                                          break;
                        case "abc": if(count >= 8) { count = 4; }
                                          break;
                        case "123":   if(count >= values7.length) { count = 8; }
                       }
            ...
            public void actionPerformed( ActionEvent ev ) {
                ...
                if (newState) {
                   ...
                   switch (inputType) {
                       ...
                       case "abc": if(count >= 6) { count = 3; }
                                         break;
                       case "123":   if(count >= values8.length) { count = 6; }
                   }
        ...
        buttn_9.addActionListener( new ActionListener() {
            ...
            public void actionPerformed( ActionEvent ev ) {
                ...
                if (newState) {
                    ...
                    case "abc": if(count >= 8) { count = 4; }
                                      break;
                    case "123":   if(count >= values9.length) { count = 8; }
                   }
